...
export const blog1 = `<div class="mainTopics blog-one" id="firstBlog">
<h2 class="py-4 px-3 my-2 d-flex align-items-center mx-4 rounded">الأمراض المزمنة</h2>
<div class="container">
