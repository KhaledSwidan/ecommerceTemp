...
export const blog4 = `<div class="mainTopics blog-four" id="forthBlog">
<h2 class="py-4 px-3 my-2 d-flex align-items-center mx-4 rounded">الحياة اليومية</h2>
<div class="container">
