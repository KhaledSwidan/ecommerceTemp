...
export const blog0 = `<div class="mainTopics general" id="generalBlog">
<h2 class="py-4 px-3 my-2 d-flex align-items-center mx-4 rounded">أحدث الأخبار الطبية</h2>
<div class="container">
