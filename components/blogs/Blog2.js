...
export const blog2 = `<div class="mainTopics blog-two" id="secondBlog">
<h2 class="py-4 px-3 my-2 d-flex align-items-center mx-4 rounded">الأمراض الموسمية</h2>
<div class="container">
