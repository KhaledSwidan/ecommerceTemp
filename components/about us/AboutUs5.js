export const fifthContent = `<div class="col-md-6 col-lg-4 mt-3">
<div class="feat border-start border-end border-primary px-2 pt-4 pt-4">
  <i class="fa-solid fa-lightbulb icon"></i>
  <h4 class="my-3 text-uppercase fw-bold">الرؤية والمهمة</h4>
  <p class="lh-lg">
